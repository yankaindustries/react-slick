...
var renderSlides = function renderSlides(spec) {
  ...
  _react["default"].Children.forEach(spec.children, function(elem, index) {
    ...
    var slidesAccessibility = _objectSpread(
      _objectSpread(
        _objectSpread(
          _objectSpread(
            {},
    ...
    if (spec.infinite && spec.fade === false) {
      ...
      if (
        ...
        var preCloneSlidesAccessibility = _objectSpread(
          _objectSpread(
            _objectSpread(
              {},
              !spec.ac360Accessibility && {
      ...
      if (childrenCount !== spec.slidesToShow) {
        ...
        var postCloneSlidesAccessibility = _objectSpread(
          _objectSpread(
            _objectSpread(
              {},
              !spec.ac360Accessibility && {
  ...
  _createClass(Track, [
    {
      ...
      value: function render() {
        ...
        var accessibility = _objectSpread(
          {},
          !!accesibilityRegion && {
            role: "region",
