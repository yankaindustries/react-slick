...
var _accessibilityProps = _interopRequireDefault(
  require("./accessibility/accessibility-props")
);
  ...
  _createClass(Slider, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        if (settings.accessibility && settings.ac360Accessibility) {
          settings = _objectSpread(
            _objectSpread({}, settings),
            _accessibilityProps["default"]
          );
