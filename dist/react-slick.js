...
/* harmony import */ var _accessibility_accessibility_props__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(17);
/* harmony import */ var _utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8);
...
var enquire = Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_5__["canUseDOM"])() && __webpack_require__(18);
  ...
  _createClass(Slider, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.responsive) {
        ...
        breakpoints.forEach(function (breakpoint, index) {
          ...
          Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_5__["canUseDOM"])() && _this2.media(bQuery, function () {
            _this2.setState({
        ...
        Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_5__["canUseDOM"])() && this.media(query, function () {
          _this2.setState({
            breakpoint: null
          });
        });
    ...
    value: function render() {
      ...
      if (settings.accessibility && settings.ac360) {
        settings = _objectSpread(_objectSpread({}, settings), _accessibility_accessibility_props__WEBPACK_IMPORTED_MODULE_4__["default"]);
...
/* harmony import */ var _accessibility_accessiblity_components__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(12);
...
var InnerSlider = /*#__PURE__*/function (_React$Component) {
  ...
  function InnerSlider(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onHandleAccessibilityAutoPlayToggle", function () {
      return _this.props.autoplay && _this.state.autoplaying === 'playing' ? _this.pause("paused") : _this.autoPlay();
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "render", function () {
      ...
      var _this$props2 = _this.props,
          ...
          accessibility = _this$props2.accessibility,
          ac360 = _this$props2.ac360;
      trackProps = _objectSpread(_objectSpread({}, trackProps), {}, {
        onMouseEnter: pauseOnHover ? _this.onTrackOver : null,
        onMouseLeave: pauseOnHover ? _this.onTrackLeave : null,
        onMouseOver: pauseOnHover ? _this.onTrackOver : null,
        focusOnSelect: _this.props.focusOnSelect && _this.clickable ? _this.selectHandler : null,
        showAccesibilityRole: accessibility && ac360 && spec.useGroupRole,
        accesibilityRegion: accessibility && ac360 && _this.props.regionLabel
      });
      var dots;
      ...
      var listProps = {
        ...
        onKeyDown: _this.props.accessibility && !_this.props.ac360 ? _this.keyHandler : null
      };
      ...
      var showAccessibilityInstructions = _this.props.accessibility && _this.props.instructionsText != null && _this.props.instructionsText != '';
      var showAccessibilityPause = _this.props.accessibility && _this.props.autoplay && _this.props.useAutoplayToggleButton;
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", innerSliderProps, showAccessibilityInstructions && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_accessibility_accessiblity_components__WEBPACK_IMPORTED_MODULE_8__["AccessibilityInstructions"], {
        instructions: _this.props.instructionsText
      }), showAccessibilityPause && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_accessibility_accessiblity_components__WEBPACK_IMPORTED_MODULE_8__["AccessibilityAutoPlayToggle"], {
        isAutoPlaying: _this.state.autoplaying === 'playing',
        onToggle: _this.onHandleAccessibilityAutoPlayToggle
      }), !_this.props.unslick ? prevArrow : "", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", _extends({
...
var renderSlides = function renderSlides(spec) {
  ...
  react__WEBPACK_IMPORTED_MODULE_0___default.a.Children.forEach(spec.children, function (elem, index) {
    ...
    var slidesAccessibility = _objectSpread(_objectSpread(_objectSpread(_objectSpread({}, spec.showAccesibilityRole && {
      role: 'group',
      'aria-label': "slide ".concat(index)
    }), !spec.ac360 && {
      'aria-hidden': !slideClasses['slick-active']
    }), spec.ac360 && !slideClasses['slick-active'] && {
      'aria-hidden': true
    }), {}, {
      tabIndex: -1
    ...
    slides.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.cloneElement(child, _objectSpread(_objectSpread({
    ...
    if (spec.infinite && spec.fade === false) {
      ...
      if (preCloneNo <= Object(_utils_innerSliderUtils__WEBPACK_IMPORTED_MODULE_2__["getPreClones"])(spec) && childrenCount !== spec.slidesToShow) {
        ...
        var preCloneSlidesAccessibility = _objectSpread(_objectSpread(_objectSpread({}, !spec.ac360 && {
          'aria-hidden': !slideClasses['slick-active']
        }), spec.ac360 && !slideClasses['slick-active'] && {
          'aria-hidden': true
        }), {}, {
        ...
        preCloneSlides.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.cloneElement(child, _objectSpread(_objectSpread({
      ...
      if (childrenCount !== spec.slidesToShow) {
        ...
        var postCloneSlidesAccessibility = _objectSpread(_objectSpread(_objectSpread({}, !spec.ac360 && {
          'aria-hidden': !slideClasses['slick-active']
        }), spec.ac360 && !slideClasses['slick-active'] && {
          'aria-hidden': true
        }), {}, {
        ...
        postCloneSlides.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.cloneElement(child, _objectSpread(_objectSpread({
  ...
  _createClass(Track, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          accesibilityRegion = _this$props.accesibilityRegion;
      var mouseEvents = {
      ...
      var accessibility = _objectSpread({}, !!accesibilityRegion && {
        role: 'region',
      ...
      }, mouseEvents, accessibility), slides);
    }
  }]);
...
var PrevArrow = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(PrevArrow, [{
    ...
    value: function render() {
      ...
      prevArrowProps = _objectSpread(_objectSpread({}, prevArrowProps), {}, {
        key: "0",
...
var NextArrow = /*#__PURE__*/function (_React$PureComponent2) {
  ...
  _createClass(NextArrow, [{
    ...
    value: function render() {
      ...
      nextArrowProps = _objectSpread(_objectSpread({}, nextArrowProps), {}, {
        key: "1",
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AccessibilityInstructions", function() { return AccessibilityInstructions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AccessibilityAutoPlayToggle", function() { return AccessibilityAutoPlayToggle; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
function AccessibilityAutoPlayToggle(_ref2) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
    ...
    onClick: onToggle
  }, isAutoPlaying ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
...
var accessibilityProps = {
  ...
  playIcon: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
    className: "slick-play-icon",
    "aria-hidden": "true"
  }),
  pauseIcon: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
    className: "slick-pause-icon",
    "aria-hidden": "true"
  }),
...
/* harmony default export */ __webpack_exports__["default"] = (accessibilityProps);

/***/ }),
/* 18 */
/***/ (function(module, exports, __webpack_require__) {

var MediaQueryDispatch = __webpack_require__(19);
...
var MediaQuery = __webpack_require__(20);
...
var QueryHandler = __webpack_require__(21);
